angular.module('aymApp.contact', ['ui.router'])
.config(function ($stateProvider, $urlRouterProvider) {
  ...
  .state('contacts.list', {
    ...
    templateUrl: 'views/contact/contacts.list.html'
  })
  ...
  .state('contacts.detail', {
    ...
    views: {
      ...
      '': {
        templateUrl: 'views/contact/contacts.detail.html',
  ...
  .state('contacts.detail.item', {
    ...
    views: {
      ...
      '': {
        templateUrl: 'views/contact/contacts.detail.item.html',
  ...
  .state('contacts.detail.item.edit', {
    views: {
      ...
      '@contacts.detail': {
        templateUrl: 'views/contact/contacts.detail.item.edit.html',
        controller: ['$scope', '$stateParams', '$state', 'utils',
          function ($scope, $stateParams, $state, utils) {
            $scope.item = utils.findById($scope.contact.items, $stateParams.itemId);
            $scope.done = function () {
...
factory('contacts', function ($http, utils) {
  var path = 'views/contact/test/contacts.json';
